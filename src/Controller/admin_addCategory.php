...
$titleCategory= htmlspecialchars(strip_tags(trim($_POST['titleCategory'])));
$descriptionCategory = htmlspecialchars(strip_tags(trim($_POST['descriptionCategory']))); 
$actifCategory = htmlspecialchars(strip_tags(trim($_POST['actifCategory'])));  
...
include '../templates/base_form.phtml';
